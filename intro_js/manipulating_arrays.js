...
let samsDogs = ["finnick", "prim", "bailey"];

console.log("before",samsDogs);

samsDogs.unshift("luna");
...
console.log("fetching index of \"prim\"...");

console.log("luna's index ", samsDogs.indexOf("prim"));
...
console.log("reversed", samsDogs.reverse())

console.log("sort() dogs", samsDogs.sort())

console.log("samDogs as string ", samsDogs.join("-"))


let searchTerms = "soup,  tomato, no-garlic, 1Hour"

let parsedSearchTerms = searchTerms.split(",")
